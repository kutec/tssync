...
`is_singular()` targets all the templates with `content-{something}.php` files name in your theme. So if you have some code to manipulate with all single pages then you should use `is_singular()`.
