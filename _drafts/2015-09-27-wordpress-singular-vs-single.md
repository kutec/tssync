...
To make it simple, `is_singular()` targets all the templates with `content-{something}.php` files name in your theme. So if you have something to be manipulating with all single pages
