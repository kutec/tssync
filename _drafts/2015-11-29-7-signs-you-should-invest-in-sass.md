...
post_date: 2015-11-29 06:39:33
post_excerpt: ""
layout: post
permalink: http://teckstack.com/?p=4419
published: false
---
<blockquote class="blockquote-reverse"><p>Writing CSS is an easy task. But doing the same in proper manner, which can be understood by all developers in a team that is more important.</p>
<footer>Manish Sharma <cite title="If I Use (http://ifiuse.com)"><em>open source developer</em></cite></footer>
</blockquote>
