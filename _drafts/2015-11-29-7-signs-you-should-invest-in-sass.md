...
Big projects may needed numbers of CSS files based on features and requirement of the project. As mentioned previously,  such a project has many developers in a team