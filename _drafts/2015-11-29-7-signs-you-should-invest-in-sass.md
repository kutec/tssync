...
As you can see that we will be only getting one CSS file as a CSS output and it also looks more manageable. Such an approach help specially in a distributed project as we discussed in <em>weather module example</em>.
