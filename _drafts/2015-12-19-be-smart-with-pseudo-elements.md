...
Let's assume a real time example of <strong>advertisements for a blog</strong>. Blog can have multiple sections to show advertisements. Sometimes, such ads may be dynamically implemented.