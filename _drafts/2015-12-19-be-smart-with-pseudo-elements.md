...
&lt;/blockquote&gt;</pre>
<strong>&lt;blockquote&gt; </strong>tag used for a quoted statement. But this is just another tag as <strong>&lt;div&gt;</strong>. And hence we required extra tags as mentioned in above code to add "double quotes" as in the image above. Of course, we can use &lt;span&gt; tags without classes and can use :first-child and :last-child instead. But that again the same thing, we are adding up two extra tags.