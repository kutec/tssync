...
The most common example is the <strong>quoted statements</strong> on a web page. Quotations are the emphasized text block, which needs minimum 3 element