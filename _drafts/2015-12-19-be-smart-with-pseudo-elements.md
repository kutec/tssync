...
Let's assume a real time example, where Blog can have multiple sections reserved for advertisements. Sometimes, such ads may be coming up dynamically where we do not have flexibility to add extra element for styling purpose.